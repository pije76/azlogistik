...
//     // const databank = aksesdb.AllDb
    ...
    // const my_query = pool.query("SELECT TIMESTAMP, value, card FROM my_table ORDER BY TIMESTAMP DESC LIMIT 1");
    ...
    // res.status(201).send(
    // {
    //     message: 'New Album created', result.rows[0].id
    // });
